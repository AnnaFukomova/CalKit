...
<html lang="en">
    <head>
        ...
        <meta name="description" content=" In the «Payment Methods» category of our CalKit Knowledge Base, you will find answers to the most common questions about CalKit.pro calculator and form builder. The section features 3 step-by-step guides."/>
        ...
        <title>CalKit-FAQ Payment Systems</title>
    </head>
    <body>
        <div class="mask">
