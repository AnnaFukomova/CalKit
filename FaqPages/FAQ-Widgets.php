...
<html lang="en">
    <head>
        ...
        <meta name="description" content="In the «Widgets» category of our CalKit Knowledge Base, you will find answers to the most common questions about CalKit.pro calculator and form builder. The section features 11 step-by-step guides."/>
        ...
        <title>CalKit-FAQ Publication</title>
    </head>
    <body>
        <div class="mask">
        ...
        <section>
            ...
            <section class="section-informationMaterials">
                <div class="section-container flex">
                    ...
                    <dl class="qestion">   
                        <h3 class="qestion-header less-text Bold-text">Widgets</h3>                  
                        ...
                        <div class="qestionContainer">
                            ...
                            <div class="content">
                                <dd class="qestion-punct__description">
                                    In the element settings, turn on the Required field option. The required field will be automatically marked with an asterisk
                                </dd>
                            </div>
                        </div>
                        ...
                        <div class="qestionContainer">
                            <button type="button" class="trigger"><img src="img/documents-file.svg" loading="lazy" alt="Question document">
                                <dt class="qestion-punct simple-text text-color__bark Normal-text">
                                    Duplicating Project Widgets 
                                </dt>
                            </button>
                            <div class="content">
                                <dd class="qestion-punct__description">
                                    Mouse over the widget that you’d like to copy and click Duplicate in this widget’s settings.
                                </dd>
                            </div>
                        </div>
                        ...
                        <div class="qestionContainer">
                            ...
                            <div class="content">
                                <dd class="qestion-punct__description">
                                    You can set up image attributes (alt and title texts) in the widget's settings
                                </dd>
                            </div>
                        </div>
                        ...
                        <div class="qestionContainer">
                            <button type="button" class="trigger"><img src="img/documents-file.svg" loading="lazy" alt="Question document">
                                <dt class="qestion-punct simple-text text-color__bark Normal-text">
                                    Changing a value of a division in the Slider widget
                                </dt>
                            </button>
                            <div class="content">
                                <dd class="qestion-punct__description">
                                    Go to the widget's settings to configure a value of a division
                                </dd>
                            </div>
                        </div>
                        ...
                        <div class="qestionContainer">
                            <button type="button" class="trigger"><img src="img/documents-file.svg" loading="lazy" alt="Question document">
                                <dt class="qestion-punct simple-text text-color__bark Normal-text">
                                    Hiding numbers from the slider's scale 
                                </dt>
                            </button>
                            <div class="content">
                                <dd class="qestion-punct__description">
                                    Go to the widget's settings and disable the Numbers in a range option
                                </dd>
                            </div>
                        </div>
                        ...
                        <div class="qestionContainer">
                            <button type="button" class="trigger"><img src="img/documents-file.svg" loading="lazy" alt="Question document">
                                <dt class="qestion-punct simple-text text-color__bark Normal-text">
                                    Changing the slider's range 
                                </dt>
                            </button>
                            <div class="content">
                                <dd class="qestion-punct__description">
                                    <p><b>Method #1</b></p> 
                                    <p>Go to the Design tab and click on the gear icon to proceed to settings. In the window that will appear, you will be able to change the range</p>
                                    <p><b>Method #2</b></p>
                                    <p>Go to the Formula tab then edit the range values.</p>
                                </dd>
                            </div>
                        </div>
